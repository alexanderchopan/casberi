...
enum BridgeCatalog {
    ...
    static let offers: [Offer] = [
        ...
        Offer(name: "Bankr",       tagline: "The tokens you launched",              group: "Your agent",     connectable: true,
              summary: "Bankr is where you launch tokens. The ones you made are public, so this connects with just your creator address — no key. They land in your feed as things. Read-only: Casberi never trades or moves funds.",
              needsSetup: true),
