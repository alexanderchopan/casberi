...
enum BridgeCatalog {
    ...
    static let offers: [Offer] = [
        ...
        Offer(name: "Wallet",      tagline: "Track any wallet's activity",          group: "Your wallet",    connectable: true,
        ...
        Offer(name: "Dexscreener", tagline: "Track any token",                       group: "Your wallet",    connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Kalshi",      tagline: "Watch real-event odds",                 group: "Your markets",   connectable: true,
        ...
        Offer(name: "Apple Music", tagline: "What you play stays in reach",          group: "Your listening", connectable: true,
        ...
        Offer(name: "Todoist",     tagline: "Tasks beside your lists",               group: "Your schedule",  connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Slack",       tagline: "Messages worth keeping",                group: "Your work",      connectable: false,
              summary: "The messages you save land as findable things — decisions and links stop drowning in channels."),
        Offer(name: "Pinterest",   tagline: "Your pins, in your feed",               group: "Your saves",     connectable: true,
        ...
        Offer(name: "Readwise",    tagline: "Highlights stay with you",              group: "Your reading",   connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Apple Journal", tagline: "Your entries, findable",              group: "Your notes",     connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Day One",     tagline: "Import your journal",                   group: "Your notes",     connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Apple Notes", tagline: "Share notes in",                        group: "Your notes",     connectable: true,
        ...
        Offer(name: "RSS",         tagline: "Any site with a feed",                  group: "Your reading",   connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Farcaster",   tagline: "Track any Farcaster account",           group: "Your network",   connectable: true,
        ...
        Offer(name: "Bluesky",     tagline: "Your posts, in your feed",              group: "Your network",   connectable: true,
              ...
              needsSetup: true),
        Offer(name: "X",           tagline: "Bookmarks become findable",             group: "Your network",   connectable: false,
        ...
        Offer(name: "Steam",       tagline: "What you play, in your feed",           group: "Your games",     connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Obsidian",    tagline: "Your vault, beside your things",        group: "Your notes",     connectable: true,
