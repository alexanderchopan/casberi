...
enum BridgeCatalog {
    ...
    static let offers: [Offer] = [
        ...
        Offer(name: "ChatGPT",     tagline: "Import your chats, keep them findable", group: "Agent",     connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Claude",      tagline: "Connect it to your things",             group: "Agent",     connectable: false,
        ...
        Offer(name: "Notion",      tagline: "Pages join your things",                group: "Work",      connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Reddit",      tagline: "Saved posts become findable",           group: "Saves",     connectable: false,
              summary: "Your saved posts join your things and become searchable instead of lost in a list."),
        Offer(name: "YouTube",     tagline: "Your likes and playlists, findable",    group: "Watching",  connectable: false,
