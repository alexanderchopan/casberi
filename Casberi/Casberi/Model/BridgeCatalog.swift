...
enum BridgeCatalog {
    ...
    static let offers: [Offer] = [
        ...
        Offer(name: "iCloud Mail", tagline: "Your @icloud.com inbox, findable",      group: "Mail",      connectable: true,
              ...
              needsSetup: true),
        Offer(name: "ChatGPT",     tagline: "Import chats · your key powers answers", group: "Agent",     connectable: true,
              summary: "A one-time import of your chat history, kept searchable alongside your things. (No live read — OpenAI doesn't offer one; this is your export, backfilled.) Add your OpenAI key and every answer offers \"Try with GPT\" — on your tap, billed to your key.",
              needsSetup: true),
        Offer(name: "Claude",      tagline: "Import chats · your key powers answers", group: "Agent",     connectable: true,
              summary: "A one-time import of your Claude chat history, kept searchable alongside your things. (No live read — Anthropic doesn't offer one; this is your export, backfilled.) Add your Anthropic key and every answer offers \"Try with Claude\" — on your tap, billed to your key.",
              needsSetup: true),
        Offer(name: "Gemini",      tagline: "Your key powers answers",               group: "Agent",     connectable: true,
              summary: "Bring your Google AI key and every answer offers \"Try with Gemini\" — the question and its matched things go straight from this iPhone to Google's API, only when you tap, billed to your key.",
              needsSetup: true),
        ...
        Offer(name: "Kalshi",      tagline: "Watch real-event odds",                 group: "Markets",   connectable: true,
              ...
              needsSetup: true),
        Offer(name: "Venice",      tagline: "Private AI · your key powers answers",   group: "Agent",     connectable: true,
              summary: "Venice keeps chats on your own device by design, so there's nothing to read in — instead, your Venice key powers Casberi's answers: every answer offers \"Try with Venice\", on your tap, billed to your key. Private by both sides' rules.",
              needsSetup: true),
