...
enum BridgeCatalog {
    ...
    static let allOffers: [Offer] = [
        ...
        Offer(name: "Polymarket", tagline: "Watch any prediction market",           group: "Markets",   connectable: true,
              summary: "Watch any market on Polymarket, the onchain prediction-market exchange — search a question and its live odds land in your feed, real price history included. Public price data only, read-only: nothing here places a trade.",
