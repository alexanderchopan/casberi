...
enum NetworkReach {
    ...
    static let endpoints: [Endpoint] = [
        ...
        Endpoint(service: "Wallet DeFi & Safe",
                 reach: .whenConnected(bridge: "Wallet"),
                 purpose: "Reads your Aave and Morpho lending positions and any Safe signatures awaiting you, for the wallets you watch — keyless, public data.",
                 hosts: ["blue-api.morpho.org", "app.morpho.org", "app.aave.com", "api.safe.global"]),
