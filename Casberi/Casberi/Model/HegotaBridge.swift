...
enum HegotaBridge {
    ...
    static func registerBridge(store: BridgeStore) {
        ...
        store.registerConnected(
            ...
            can: [
                String(localized: "Reads a watched address's balance, its transfers, the unspent UTXOs it holds in the chain's vault and who paid for its transactions, on Hegotá — a public devnet testing frame transactions."),
