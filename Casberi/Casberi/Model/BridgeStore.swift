    ...
    private static let walletSeats: [WalletSeat] = [
        ...
        WalletSeat(id: "railgun", name: "Railgun",
                   ...
                   can: ["Reads what you shield into Railgun and what comes back out, for the wallets you watch, from the public chain.",
                         "Never sees inside the pool — private activity stays private, and an unshield never names who sent it.",
                         "Shows moves made straight from your wallet; ones sent through Railgun's relayer leave no public trace.",
