...
enum FramesKey {
    ...
    private static let service = "casberi-frames-signer"
    private static let account = "device-secp256k1"
    private static let addressKey = "frames.signer.address"
    ...
    /// rail (`select`).
    private static let addressesKey = "frames.signer.addresses"
    private static let currentKey = "frames.signer.current"
