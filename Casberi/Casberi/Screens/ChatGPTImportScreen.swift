...
struct ChatGPTImportScreen: View {
    ...
    var body: some View {
        List {
            ...
            // answers is the live verb; the import is the one-time backfill.
            AIKeySection(provider: .openai)
    ...
    // MARK: - Steps (the export happens on OpenAI's side — say so plainly)

    private var stepsSection: some View {
        Section {
            step(1, "In ChatGPT, open Settings → Data controls → Export data.")
