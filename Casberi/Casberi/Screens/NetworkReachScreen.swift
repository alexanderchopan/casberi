...
struct NetworkReachScreen: View {
    ...
    var body: some View {
        List {
            Section {
                Text("Casberi has no server. Every request below goes straight from \(DS.device) to the service named — nothing routes through us, because there is no us to route through.\n\nThis is the whole list.")
