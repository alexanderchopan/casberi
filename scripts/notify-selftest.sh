...
let outnumbered = NotifyDigest.plan([
    worked("p1", "Stripe", .payoutPaid, body: "Payout $1,820.00", usd: 1820, at: 10),
    worked("p2", "Stripe", .payoutPaid, body: "Payout $90.00", usd: 90, at: 11),
