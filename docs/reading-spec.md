...
**Grade: PASSES 1, 3 AND 5 BUILT; PASS 4 DECLINED; PASS 2 SPEC ONLY (2026-09-08).** Pass 1 shipped as A.1
...
closed rather than deferred. **Pass 3 is BUILT** — see §645 amendment 5 for the three things that moved on contact, and for the §399 ruling it overturns on purpose. Only pass 2 is unbuilt, and it is blocked on a measurement that needs a real photo library. **A.5's item 4 is answered** — see §645 amendment 4. Every file, line and constant is read off the tree at 2026-09-08 and
...
| 3 | Next / previous — **BUILT 2026-09-08** | — | two bounded reads | — |
